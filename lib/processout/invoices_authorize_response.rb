...
module ProcessOut
  class InvoicesAuthorizeResponse
    ...
    # Initializes the InvoicesAuthorizeResponse object
    # Params:
    ...
    # Create a new InvoicesAuthorizeResponse using the current client
    def new(data = {})
      InvoicesAuthorizeResponse.new(@client, data)
    end
